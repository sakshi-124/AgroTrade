...
public class User_PlaceOrder_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // radioButtononline=(RadioButton)findViewById(R.id.online);
        ...
        total();
            ...
            new AsyncUserData().execute("customer", "id", Name1);
        ...
        change_address.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i1= new Intent(User_PlaceOrder_Activity.this, Change_OrderDeliveryAddress_User_Activity.class);
            ...
            public void onClick(View view) {
                ...
                if(radioButtoncod.getText().equals("Cash on delivery"))
                {
                   ...
                   new AsyncPlaceOrder().execute(order,Name1,MainAdd,"cod");
                    ...
                    Toast.makeText(User_PlaceOrder_Activity.this, "COD", Toast.LENGTH_SHORT).show();
                }
                    ...
                    Toast.makeText(User_PlaceOrder_Activity.this, "Online", Toast.LENGTH_SHORT).show();
...
//        }
    ...
    class AsyncUserData extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd = new ProgressDialog(User_PlaceOrder_Activity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                Toast.makeText(User_PlaceOrder_Activity.this,"" + result, Toast.LENGTH_SHORT).show();
...
//                    crop_info.setHarvesting(harvesting);
                ...
                Toast.makeText(User_PlaceOrder_Activity.this, "Something went wrong :(" + e, Toast.LENGTH_SHORT).show();
            }
...
//                shopAdapter.notifyDataSetChanged();
    ...
    class AsyncPlaceOrder extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            String result = "";
            result = new HTTPRequestDAO().CropOrder(params[0], params[1],params[2],params[3]);
            return result;
        }
...
//                    f_id=  Integer.toString(mdm.getF_id());
                    ...
                    Toast.makeText(User_PlaceOrder_Activity.this, "Order Placed", Toast.LENGTH_LONG).show();
//                   launchHomeScreen();
                   ...
                   mDatabase.delete();
                    ...
                    Intent i1= new Intent(User_PlaceOrder_Activity.this, All_OrdersShow_Activity.class);
...
//                    launchHomeScreen();
                    ...
                    Toast.makeText(User_PlaceOrder_Activity.this, "Inavild Credentials", Toast.LENGTH_LONG).show();

                }

            } catch (Exception e) {
                Toast.makeText(User_PlaceOrder_Activity.this, "invalid server", Toast.LENGTH_LONG).show();
            }
        }
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (mdm.getData() == 200) {
                    ...
                    final AlertDialog.Builder dialog = new AlertDialog.Builder(User_PlaceOrder_Activity.this).setTitle("Payment").setMessage("Please Confirm Your Payment?");
...
// Hide after some seconds
                    ...
                    final Runnable runnable = new Runnable() {
                        ...
                        public void run() {
                            if (alert.isShowing()) {
                                alert.dismiss();
                                Intent  intent=new Intent(User_PlaceOrder_Activity.this, Farmer_login.class);
...
//                    startActivity(intent);
                    ...
                    Toast.makeText(User_PlaceOrder_Activity.this, "Order Placed" + Urrl, Toast.LENGTH_LONG).show();
//                   launchHomeScreen();

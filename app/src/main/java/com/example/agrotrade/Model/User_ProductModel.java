...
//    String p_img;
    ...
    public User_ProductModel() {
    }

    public User_ProductModel(int id, String pro_id, String p_name, String prize, String img, String qty) {
        this.pro_id = pro_id;
        this.id = id;
        this.p_name = p_name;
        this.prize = prize;
    ...
    public User_ProductModel(String pro_id, String p_name, String prize, String img, String qty) {
        this.pro_id = pro_id;
        this.p_name = p_name;
        this.prize = prize;
        this.img = img;

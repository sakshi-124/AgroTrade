...
import com.example.agrotrade.Farmer.Farmer_PlaceOrder_Activity;
...
public class Farmer_ProductCartActivity extends AppCompatActivity implements AdapterView.OnClickListener{

    /*private static final String TAG = MainActivity.class.getSimpleName();*/
    private SqliteDatabase mDatabase;
    Farmer_ProductAdapter mAdapter;
    Double amount;
    Button place_order;
    int mytotal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final List<Ferti_Pesti_Buying> allProducts = mDatabase.listProductsFerti();
        if(allProducts.size() > 0){
            mytext.setVisibility(View.INVISIBLE);
            productView.setVisibility(View.VISIBLE);
            place_order.setVisibility(View.VISIBLE);
          mAdapter = new Farmer_ProductAdapter(this, allProducts);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // add new quick task
                Intent intent=new Intent(Farmer_ProductCartActivity.this, All_FertiPesti_Buying.class);
...
//        });
        ...
        place_order.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for (Ferti_Pesti_Buying value : allProducts)
                {
                   ...
                   // Toast.makeText(Farmer_ProductCartActivity.this, "" +value.getPrice(), Toast.LENGTH_SHORT).show();
                        ...
                        for (int i = 0; i < allProducts.size(); i++) {
                            ...
                            try {
                               ...
                               subtotal=   Integer.valueOf(value.getPrice());
                                ...
                                obj.put("pro_id", value.getId());
                                obj.put("product_name", value.getName());
...
//                                obj.put("qty", value.getQty());
                                ...
                                Toast.makeText(Farmer_ProductCartActivity.this, "" + e, Toast.LENGTH_SHORT).show();
...
//                        String url = "http://www.test.com?response="+finalobject.toString();
                ...
                try {
                   ...
                   //Toast.makeText(Farmer_ProductCartActivity.this, "success" + finalobject.toString(), Toast.LENGTH_SHORT).show();
                    ...
                    Intent i = new Intent(Farmer_ProductCartActivity.this, Farmer_PlaceOrder_Activity.class);

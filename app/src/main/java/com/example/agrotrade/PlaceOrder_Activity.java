...
import com.example.agrotrade.User.Change_OrderDeliveryAddress_User_Activity;
       ...
       // radioButtononline=(RadioButton)findViewById(R.id.online);
        ...
        change_address.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i1= new Intent(PlaceOrder_Activity.this, Change_OrderDeliveryAddress_User_Activity.class);
            ...
            public void onClick(View view) {
                ...
                if(radioButtoncod.getText().equals("Cash on delivery"))
                {
                   ...
                   new AsyncPlaceOrder().execute(order,Name1,MainAdd,"cod");
                    ...
                    Toast.makeText(PlaceOrder_Activity.this, "COD", Toast.LENGTH_SHORT).show();
                }
                    ...
                    Toast.makeText(PlaceOrder_Activity.this, "Online", Toast.LENGTH_SHORT).show();
...
//        }
    ...
    class AsyncUserData extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd = new ProgressDialog(PlaceOrder_Activity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                Toast.makeText(PlaceOrder_Activity.this,"" + result, Toast.LENGTH_SHORT).show();
...
//                    crop_info.setHarvesting(harvesting);
                ...
                Toast.makeText(PlaceOrder_Activity.this, "Something went wrong :(" + e, Toast.LENGTH_SHORT).show();
            }
...
//                    f_id=  Integer.toString(mdm.getF_id());
                    ...
                    Toast.makeText(PlaceOrder_Activity.this, "Order Placed", Toast.LENGTH_LONG).show();
//                   launchHomeScreen();
...
//                    launchHomeScreen();
                    ...
                    Toast.makeText(PlaceOrder_Activity.this, "Inavild Credentials", Toast.LENGTH_LONG).show();

                }

            } catch (Exception e) {
                Toast.makeText(PlaceOrder_Activity.this, "invalid server", Toast.LENGTH_LONG).show();
            }
        }
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (mdm.getData() == 200) {
                    ...
                    final AlertDialog.Builder dialog = new AlertDialog.Builder(PlaceOrder_Activity.this).setTitle("Payment").setMessage("Please Confirm Your Payment?");
...
// Hide after some seconds
                    ...
                    final Runnable runnable = new Runnable() {
                        ...
                        public void run() {
                            if (alert.isShowing()) {
                                alert.dismiss();
                                Intent  intent=new Intent(PlaceOrder_Activity.this, Farmer_login.class);
...
//                    startActivity(intent);
                    ...
                    Toast.makeText(PlaceOrder_Activity.this, "Order Placed" + Urrl, Toast.LENGTH_LONG).show();
//                   launchHomeScreen();
